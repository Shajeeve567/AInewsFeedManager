    ...
    <div className="flex min-h-[100dvh] items-center justify-center px-4 relative z-10">
      <div className="w-full max-w-sm glass-widget p-8 sm:p-10 rounded-[2.5rem]">
        ...
        <div className="mt-8 space-y-3">
          ...
          <button className="w-full flex items-center justify-center gap-2 bg-white/40 hover:bg-white/60 border border-white/60 text-fedin-dark font-medium py-3 rounded-xl transition-all duration-300 opacity-50 cursor-not-allowed" disabled title="GitHub login coming soon">
